<template>
	<div class="home">
		<div class="index_top">
			<div class="index_top_title">基于协同过滤算法的个性化音乐推荐系统</div>
			...
			<div class="rotation_view">
				<mySwiper :type="3" :data="rotationList" :autoHeight="false" :autoplay="true"
					...
					<template #default="scope">
						<img :style='{"border":"0px solid #fff","width":"100%","borderRadius":"20px","height":"400px"}' :src="scope.row.value?$config.url + scope.row.value:''">
					</template>
				</mySwiper>
			</div>
			<router-view />
...
<style lang="scss" scoped>
	...
	.menu_view {
		...
		:deep(.is-active) {
			...
			background: url(http://clfile.zggen.cn/20240315/36b523140f4a476182cbaccaf236bde6.png) no-repeat center bottom / 100% 85% !important;
