	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"20px","background":"none","width":"1200px","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="评分日期" prop="pingfenriqi">
						<el-date-picker
							class="list_date"
							v-model="form.pingfenriqi"
							format="YYYY-MM-DD HH:mm:ss"
							value-format="YYYY-MM-DD HH:mm:ss"
							type="datetime"
							style="width:100%;"
							:readonly="!isAdd||disabledForm.pingfenriqi?true:false"
							placeholder="请选择评分日期" />
					</el-form-item>
				</el-col>
				<el-col :span="24">
...
<script setup>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
			form.value.pingfenriqi = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='pingfenriqi'){
					form.value.pingfenriqi = row[x];
					disabledForm.value.pingfenriqi = true;
					continue;
				}
				if(x=='yonghuzhanghao'){
